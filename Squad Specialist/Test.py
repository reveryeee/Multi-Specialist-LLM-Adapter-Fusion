...
ADAPTER_PATH = "/content/squad_adapter"  
...
def get_response(system_prompt, user_input):
    ...
    with torch.no_grad():
        outputs = model.generate(
            **inputs,
            max_new_tokens=30, # Sometimes the answer is long, so we define 30 tokens
...
# Squad
print("Testing SQuAD v2 Specialist Strength...")
...
# SNLI
print("Testing SNLI Generalization...")
...
print("\n" + "="*40)
print("[SQuAD-Specialist Model Results]")
